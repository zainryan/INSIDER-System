...
ap_continue,
        ap_idle,
        ap_ready,
        reset_app_equalizer_V_din,
        reset_app_equalizer_V_full_n,
        reset_app_equalizer_V_write,
        reset_sigs_V_dout,
...
output   reset_app_equalizer_V_din;
input   reset_app_equalizer_V_full_n;
output   reset_app_equalizer_V_write;
...
reg ap_idle;
reg reset_app_equalizer_V_write;
...
reg    reset_app_equalizer_V_blk_n;
...
always @ (*) begin
    if (((empty_n_reg_302 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        reset_app_equalizer_V_blk_n = reset_app_equalizer_V_full_n;
    end else begin
        reset_app_equalizer_V_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((empty_n_reg_302 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        reset_app_equalizer_V_write = 1'b1;
    end else begin
        reset_app_equalizer_V_write = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = (((empty_n_reg_302 == 1'd1) & (reset_app_equalizer_V_full_n == 1'b0)) | ((empty_n_reg_302 == 1'd1) & (reset_write_mode_pre_merged_app_input_data_forwarder_V_full_n == 1'b0)) | ((empty_n_reg_302 == 1'd1) & (reset_app_input_data_merger_V_full_n == 1'b0)) | ((empty_n_reg_302 == 1'd1) & (reset_write_mode_app_output_data_caching_V_full_n == 1'b0)) | ((empty_n_reg_302 == 1'd1) & (reset_app_input_data_mux_V_full_n == 1'b0)) | ((empty_n_reg_302 == 1'd1) & (reset_app_output_data_demux_V_full_n == 1'b0)) | ((empty_n_reg_302 == 1'd1) & (reset_pcie_data_splitter_app_V_full_n == 1'b0)) | ((empty_n_reg_302 == 1'd1) & (reset_write_mode_pcie_helper_app_V_full_n == 1'b0)) | ((empty_n_reg_302 == 1'd1) & (reset_read_mode_pcie_helper_app_V_full_n == 1'b0)) | ((empty_n_reg_302 == 1'd1) & (reset_write_mode_dram_helper_app_V_full_n == 1'b0)) | ((empty_n_reg_302 == 1'd1) & (reset_read_mode_dram_helper_app_V_full_n == 1'b0)));
end
...
assign reset_app_equalizer_V_din = 1'd0;
