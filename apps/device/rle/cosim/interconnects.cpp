...
void interconnects() {
  ...
  reset_propaganda(
      reset_app_rle_combine, reset_app_rle_expand, reset_app_rle_prefix_sum,
  ...
  ;
  ;
  app_rle_prefix_sum(reset_app_rle_prefix_sum, app_input_params, app_input_data,
                     app_rle_expand_input_data);
  app_rle_expand(reset_app_rle_expand, app_rle_expand_input_data,
                 app_rle_combine_input_data);
  app_rle_combine(reset_app_rle_combine, app_rle_combine_input_data,
                  app_output_data);
}
