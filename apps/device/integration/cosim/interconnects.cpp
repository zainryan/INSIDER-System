...
void interconnects() {
  ...
  reset_propaganda(
      reset_app_intg_matcher, reset_app_intg_mat_rdc, reset_app_intg_rdc_16to8,
      reset_app_intg_rdc_32to16, reset_app_intg_rdc_4to2,
      reset_app_intg_rdc_8to4, reset_app_intg_verifier, reset_app_intg_writer,
