...
void app_conv_combine_l1_0(
  ...
  struct APP_Combine_L1_Data input_data_0;
  ;
  struct APP_Combine_L1_Data input_data_1;
  ;
  ;
  ...
  while (1) {
    bool dummy;
    if (reset || (reset = reset_app_conv_combine_l1_0.read_nb(dummy))) {
      input_data_0 = APP_Combine_L1_Data();
      input_data_1 = APP_Combine_L1_Data();
      data_0_ready = false;
      data_1_ready = false;
      reset_cnt++;
...
#pragma HLS pipeline
      combine_l1(app_conv_combine_l1_input_data_0,
                 app_conv_combine_l1_input_data_1,
                 &app_conv_combine_l2_input_data_0, &input_data_0,
