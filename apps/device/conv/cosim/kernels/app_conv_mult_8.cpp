...
void app_conv_mult_8( // total 8 mult engines
    ST_Queue<bool> &reset_app_conv_mult_8,
    ST_Queue<APP_Param> &app_conv_mult_8_param,
    ST_Queue<APP_Param> &app_conv_mult_9_param,
    ST_Queue<APP_Mult_Data> &app_conv_mult_8_input_data,
    ST_Queue<APP_Mult_Data> &app_conv_mult_9_input_data,
...
#pragma HLS array_partition variable = results complete dim = 0
  ...
  while (1) {
    bool dummy;
    if (reset || (reset = reset_app_conv_mult_8.read_nb(dummy))) {
...
#pragma HLS pipeline
      mult_core(app_conv_mult_8_param, app_conv_mult_9_param,
                app_conv_mult_8_input_data, app_conv_mult_9_input_data,
                app_conv_row_reduce_8_input_data, kernels, &reg_input_data,
