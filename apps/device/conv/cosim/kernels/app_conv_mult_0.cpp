...
void app_conv_mult_0( // total 8 mult engines
    ST_Queue<bool> &reset_app_conv_mult_0,
...
#pragma HLS array_partition variable = results complete dim = 0
  ...
  while (1) {
    bool dummy;
    if (reset || (reset = reset_app_conv_mult_0.read_nb(dummy))) {
...
#pragma HLS pipeline
      mult_core(app_conv_mult_0_param, app_conv_mult_1_param,
                app_conv_mult_0_input_data, app_conv_mult_1_input_data,
                app_conv_row_reduce_0_input_data, kernels, &reg_input_data,
