...
void interconnects() {
  ...
  reset_propaganda(
      reset_app_conv_combine_l0_0, reset_app_conv_combine_l0_1,
      reset_app_conv_combine_l0_2, reset_app_conv_combine_l0_3,
      reset_app_conv_combine_l1_0, reset_app_conv_combine_l1_1,
      reset_app_conv_combine_l2_0, reset_app_conv_dist, reset_app_conv_mult_0,
      reset_app_conv_mult_10, reset_app_conv_mult_11, reset_app_conv_mult_12,
      reset_app_conv_mult_13, reset_app_conv_mult_14, reset_app_conv_mult_15,
      reset_app_conv_mult_1, reset_app_conv_mult_2, reset_app_conv_mult_3,
      reset_app_conv_mult_4, reset_app_conv_mult_5, reset_app_conv_mult_6,
      reset_app_conv_mult_7, reset_app_conv_mult_8, reset_app_conv_mult_9,
      reset_app_conv_mult_dummy, reset_app_conv_row_reduce_0,
      reset_app_conv_row_reduce_1, reset_app_conv_row_reduce_2,
      reset_app_conv_row_reduce_3, reset_app_conv_row_reduce_4,
      reset_app_conv_row_reduce_5, reset_app_conv_row_reduce_6,
      reset_app_conv_row_reduce_7, reset_app_conv_writer, reset_sigs,
      reset_read_mode_dram_helper_app, reset_write_mode_dram_helper_app,
      reset_read_mode_pcie_helper_app, reset_write_mode_pcie_helper_app,
      reset_pcie_data_splitter_app, reset_app_output_data_demux,
      reset_app_input_data_mux, reset_write_mode_app_output_data_caching,
  ...
  ;
  app_conv_dist(reset_app_conv_dist, app_input_params, app_input_data,
                app_conv_mult_0_param, app_conv_mult_0_input_data);
  app_conv_mult_0(reset_app_conv_mult_0, app_conv_mult_0_param,
                  app_conv_mult_1_param, app_conv_mult_0_input_data,
                  app_conv_mult_1_input_data, app_conv_row_reduce_0_input_data);
  app_conv_mult_1(reset_app_conv_mult_1, app_conv_mult_1_param,
                  app_conv_mult_2_param, app_conv_mult_1_input_data,
                  app_conv_mult_2_input_data, app_conv_row_reduce_1_input_data);
  app_conv_mult_2(reset_app_conv_mult_2, app_conv_mult_2_param,
                  app_conv_mult_3_param, app_conv_mult_2_input_data,
                  app_conv_mult_3_input_data, app_conv_row_reduce_2_input_data);
  app_conv_mult_3(reset_app_conv_mult_3, app_conv_mult_3_param,
                  app_conv_mult_4_param, app_conv_mult_3_input_data,
                  app_conv_mult_4_input_data, app_conv_row_reduce_3_input_data);
  app_conv_mult_4(reset_app_conv_mult_4, app_conv_mult_4_param,
                  app_conv_mult_5_param, app_conv_mult_4_input_data,
                  app_conv_mult_5_input_data, app_conv_row_reduce_4_input_data);
  app_conv_mult_5(reset_app_conv_mult_5, app_conv_mult_5_param,
                  app_conv_mult_6_param, app_conv_mult_5_input_data,
                  app_conv_mult_6_input_data, app_conv_row_reduce_5_input_data);
  app_conv_mult_6(reset_app_conv_mult_6, app_conv_mult_6_param,
                  app_conv_mult_7_param, app_conv_mult_6_input_data,
                  app_conv_mult_7_input_data, app_conv_row_reduce_6_input_data);
  app_conv_mult_7(reset_app_conv_mult_7, app_conv_mult_7_param,
                  app_conv_mult_8_param, app_conv_mult_7_input_data,
                  app_conv_mult_8_input_data, app_conv_row_reduce_7_input_data);
  app_conv_mult_8(reset_app_conv_mult_8, app_conv_mult_8_param,
                  app_conv_mult_9_param, app_conv_mult_8_input_data,
                  app_conv_mult_9_input_data, app_conv_row_reduce_8_input_data);
  app_conv_mult_9(reset_app_conv_mult_9, app_conv_mult_9_param,
                  app_conv_mult_10_param, app_conv_mult_9_input_data,
                  app_conv_mult_10_input_data,
                  app_conv_row_reduce_9_input_data);
  app_conv_mult_10(reset_app_conv_mult_10, app_conv_mult_10_param,
                   app_conv_mult_11_param, app_conv_mult_10_input_data,
                   app_conv_mult_11_input_data,
                   app_conv_row_reduce_10_input_data);
  app_conv_mult_11(reset_app_conv_mult_11, app_conv_mult_11_param,
                   app_conv_mult_12_param, app_conv_mult_11_input_data,
                   app_conv_mult_12_input_data,
                   app_conv_row_reduce_11_input_data);
  app_conv_mult_12(reset_app_conv_mult_12, app_conv_mult_12_param,
                   app_conv_mult_13_param, app_conv_mult_12_input_data,
                   app_conv_mult_13_input_data,
                   app_conv_row_reduce_12_input_data);
  app_conv_mult_13(reset_app_conv_mult_13, app_conv_mult_13_param,
                   app_conv_mult_14_param, app_conv_mult_13_input_data,
                   app_conv_mult_14_input_data,
                   app_conv_row_reduce_13_input_data);
  app_conv_mult_14(reset_app_conv_mult_14, app_conv_mult_14_param,
                   app_conv_mult_15_param, app_conv_mult_14_input_data,
                   app_conv_mult_15_input_data,
                   app_conv_row_reduce_14_input_data);
  app_conv_mult_15(reset_app_conv_mult_15, app_conv_mult_15_param,
                   app_conv_mult_dummy_param, app_conv_mult_15_input_data,
                   app_conv_mult_dummy_input_data,
                   app_conv_row_reduce_15_input_data);
  app_conv_mult_dummy(reset_app_conv_mult_dummy, app_conv_mult_dummy_param,
                      app_conv_mult_dummy_input_data);
  app_conv_row_reduce_0(
      reset_app_conv_row_reduce_0, app_conv_row_reduce_0_input_data,
      app_conv_row_reduce_1_input_data, app_conv_combine_l0_input_data_0);
  app_conv_row_reduce_1(
      reset_app_conv_row_reduce_1, app_conv_row_reduce_2_input_data,
      app_conv_row_reduce_3_input_data, app_conv_combine_l0_input_data_1);
  app_conv_row_reduce_2(
      reset_app_conv_row_reduce_2, app_conv_row_reduce_4_input_data,
      app_conv_row_reduce_5_input_data, app_conv_combine_l0_input_data_2);
  app_conv_row_reduce_3(
      reset_app_conv_row_reduce_3, app_conv_row_reduce_6_input_data,
      app_conv_row_reduce_7_input_data, app_conv_combine_l0_input_data_3);
  app_conv_row_reduce_4(
      reset_app_conv_row_reduce_4, app_conv_row_reduce_8_input_data,
      app_conv_row_reduce_9_input_data, app_conv_combine_l0_input_data_4);
  app_conv_row_reduce_5(
      reset_app_conv_row_reduce_5, app_conv_row_reduce_10_input_data,
      app_conv_row_reduce_11_input_data, app_conv_combine_l0_input_data_5);
  app_conv_row_reduce_6(
      reset_app_conv_row_reduce_6, app_conv_row_reduce_12_input_data,
      app_conv_row_reduce_13_input_data, app_conv_combine_l0_input_data_6);
  app_conv_row_reduce_7(
      reset_app_conv_row_reduce_7, app_conv_row_reduce_14_input_data,
      app_conv_row_reduce_15_input_data, app_conv_combine_l0_input_data_7);
  app_conv_combine_l0_0(
      reset_app_conv_combine_l0_0, app_conv_combine_l0_input_data_0,
      app_conv_combine_l0_input_data_1, app_conv_combine_l1_input_data_0);
  app_conv_combine_l0_1(
      reset_app_conv_combine_l0_1, app_conv_combine_l0_input_data_2,
      app_conv_combine_l0_input_data_3, app_conv_combine_l1_input_data_1);
  app_conv_combine_l0_2(
      reset_app_conv_combine_l0_2, app_conv_combine_l0_input_data_4,
      app_conv_combine_l0_input_data_5, app_conv_combine_l1_input_data_2);
  app_conv_combine_l0_3(
      reset_app_conv_combine_l0_3, app_conv_combine_l0_input_data_6,
      app_conv_combine_l0_input_data_7, app_conv_combine_l1_input_data_3);
  app_conv_combine_l1_0(
      reset_app_conv_combine_l1_0, app_conv_combine_l1_input_data_0,
      app_conv_combine_l1_input_data_1, app_conv_combine_l2_input_data_0);
  app_conv_combine_l1_1(
      reset_app_conv_combine_l1_1, app_conv_combine_l1_input_data_2,
      app_conv_combine_l1_input_data_3, app_conv_combine_l2_input_data_1);
  app_conv_combine_l2_0(
      reset_app_conv_combine_l2_0, app_conv_combine_l2_input_data_0,
      app_conv_combine_l2_input_data_1, app_conv_writer_input_data);
  app_conv_writer(reset_app_conv_writer, app_conv_writer_input_data,
                  app_output_data);
}
