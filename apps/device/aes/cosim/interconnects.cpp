...
void interconnects() {
  ...
  reset_propaganda(
      reset_app_aes_end, reset_app_aes_process_0, reset_app_aes_process_1,
      reset_app_aes_process_2, reset_app_aes_process_3, reset_app_aes_process_4,
      reset_app_aes_process_5, reset_app_aes_process_6, reset_app_aes_process_7,
      reset_app_aes_process_8, reset_app_aes_start, reset_sigs,
  ...
  ;
  ;
  app_aes_start(reset_app_aes_start, app_input_params, app_aes_proc_0_params,
                app_input_data, app_aes_proc_0_input_data);
  app_aes_process_0(reset_app_aes_process_0, app_aes_proc_0_params,
                    app_aes_proc_1_params, app_aes_proc_0_input_data,
                    app_aes_proc_1_input_data);
  app_aes_process_1(reset_app_aes_process_1, app_aes_proc_1_params,
                    app_aes_proc_2_params, app_aes_proc_1_input_data,
                    app_aes_proc_2_input_data);
  app_aes_process_2(reset_app_aes_process_2, app_aes_proc_2_params,
                    app_aes_proc_3_params, app_aes_proc_2_input_data,
                    app_aes_proc_3_input_data);
  app_aes_process_3(reset_app_aes_process_3, app_aes_proc_3_params,
                    app_aes_proc_4_params, app_aes_proc_3_input_data,
                    app_aes_proc_4_input_data);
  app_aes_process_4(reset_app_aes_process_4, app_aes_proc_4_params,
                    app_aes_proc_5_params, app_aes_proc_4_input_data,
                    app_aes_proc_5_input_data);
  app_aes_process_5(reset_app_aes_process_5, app_aes_proc_5_params,
                    app_aes_proc_6_params, app_aes_proc_5_input_data,
                    app_aes_proc_6_input_data);
  app_aes_process_6(reset_app_aes_process_6, app_aes_proc_6_params,
                    app_aes_proc_7_params, app_aes_proc_6_input_data,
                    app_aes_proc_7_input_data);
  app_aes_process_7(reset_app_aes_process_7, app_aes_proc_7_params,
                    app_aes_proc_8_params, app_aes_proc_7_input_data,
                    app_aes_proc_8_input_data);
  app_aes_process_8(reset_app_aes_process_8, app_aes_proc_8_params,
                    app_aes_end_params, app_aes_proc_8_input_data,
                    app_aes_end_input_data);
  app_aes_end(reset_app_aes_end, app_aes_end_params, app_aes_end_input_data,
              app_output_data);
}
